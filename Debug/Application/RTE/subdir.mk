...
C_SRCS += \
../Application/RTE/Rte_LightsControl.c 

OBJS += \
./Application/RTE/Rte_LightsControl.o 

C_DEPS += \
./Application/RTE/Rte_LightsControl.d 


# Each subdirectory must supply rules for building sources it contributes
Application/RTE/%.o Application/RTE/%.su: ../Application/RTE/%.c Application/RTE/subdir.mk
...
clean: clean-Application-2f-RTE

clean-Application-2f-RTE:
	-$(RM) ./Application/RTE/Rte_LightsControl.d ./Application/RTE/Rte_LightsControl.o ./Application/RTE/Rte_LightsControl.su

.PHONY: clean-Application-2f-RTE
